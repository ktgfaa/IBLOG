...
<link href="${contextPath }/resources/css/blog/updateWriteForm4.css?after" rel="stylesheet" type="text/css">
							...
							<li>
 								<div class="jsx-2303464893 editor"> 
									<div class="fr-box fr-basic fr-top" role="application"> 
										<div class="fr-wrapper show-placeholder" style="overflow: scroll;width: 1136px;"> 
											<textarea class="form_control" name="write_description" id="bo_content" style="width: 1136px; height: 500px;">
