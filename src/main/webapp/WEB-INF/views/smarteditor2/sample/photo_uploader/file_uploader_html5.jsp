...
<%
	...
	if(cnt == 0) {
		...
		String filePath = defaultPath + "resources" + File.separator + "image" + File.separator + "smarteditor2" + File.separator;
		...
		fileInfo += "&sFileURL=/iblog/resources/image/smarteditor2/" + autoFileName;
