...
<html>
<head>
<link href="${contextPath }/resources/css/blog/blogside3.css?after"
	rel="stylesheet" type="text/css">
<script type="text/javascript"
	src="https://code.jquery.com/jquery-3.2.0.min.js"></script>
<script src="<c:url value="/resources/js/blog/side3.js" />"></script>
</head>
<body>
		...
		<div class="leftSide_DIV">
			<div class="blogmyInfo_DIV">
				<ul>
					...
					<li><h3 style="margin-bottom: 1px;">${iblogbyAddress.getBlogName() }
							블로그</h3></li>
							...
							<c:if test="${sub_category ne 'none' }">
								<c:forEach var="k" begin="0" end="${sub_category.size()-1}">
									<c:if
										...
										<li><strong>-
												${sub_category.get(k).get('CATEGORY_VALUE') }</strong> <c:if
												test="${writeInfoVOList ne 'none' }">
