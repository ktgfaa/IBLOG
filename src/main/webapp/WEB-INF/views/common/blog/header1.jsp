...
<html>
<head>
<link href="${contextPath }/resources/css/blog/blogHeader1.css?after" rel="stylesheet" type="text/css">
<script type="text/javascript" src="https://code.jquery.com/jquery-3.2.0.min.js" ></script>
<script src="<c:url value="/resources/js/blog/blogHeader1.js" />"></script>
<meta charset="UTF-8">
<title>헤더</title>
<link
