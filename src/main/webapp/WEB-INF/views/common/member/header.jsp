...
<html>
<head>
<link href="${contextPath }/resources/css/member/memberHeader.css?after" rel="stylesheet" type="text/css">
<meta charset="UTF-8">
<title>헤더</title>
<link
	...
	<div class="TopDIV">
		<div class="logoDiv">
			...
			<ul class="memberList">
				...
				<li style="float: right;"><a href="${contextPath }/member/TOSForm.do"><button title="회원가입" id="user" >회원가입</button></a></li>
			</ul>
		</div>
	</div>
