...
public class MypageController {
	...
	public ModelAndView passetCheck(
	...
	public ModelAndView memberDelForm(
			HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	public ModelAndView memberDelCheck(
			@ModelAttribute("member") MemberVO memberVO,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
		logger.info("memberDelForm 실행");
		ModelAndView mav = new ModelAndView();
	...
	public ModelAndView myInfoForm(
			HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	public ModelAndView myinfoPasCheck(
			@ModelAttribute("member") MemberVO memberVO,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	public ModelAndView newIblogMakeForm(
			HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	public ModelAndView newIblog(
			@ModelAttribute("iblogInfoVO") IblogInfoVO iblogInfoVO,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	public ModelAndView iblogfixForm(
			HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	public ModelAndView addCategory(
			@ModelAttribute("iblog_categoryVO") Iblog_categoryVO iblog_categoryVO,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
		logger.info("addCategory 실행");
		ModelAndView mav = new ModelAndView();
	...
	public ModelAndView addWriteForm(
			HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	public ModelAndView writeCngSub(
			@ModelAttribute("iblog_categoryVO") Iblog_categoryVO iblog_categoryVO,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
		logger.info("writeCngSub 실행");
		ModelAndView mav = new ModelAndView();
		String cat_num = mypageDAO.selectbySubCategoryNum_write(iblog_categoryVO.getId(), iblog_categoryVO.getCategory_value().get(0));
		List<Map<String,String>> sub_category_write = mypageDAO.selectbySubCategory_write(iblog_categoryVO.getId(), cat_num);
		HttpSession session = request.getSession();
	...
	public ModelAndView addWrite(
		...
		logger.info("아이디: " + writeInfoVO.getId());
		logger.info("글 제목 : " + writeInfoVO.getWrite_subject());
		logger.info("글 메인 카테고리 : " + writeInfoVO.getWrite_main_category());
		logger.info("글 서브 카테고리 : " + writeInfoVO.getWrite_sub_category());
		logger.info("글 내용 : " + write_description);
		logger.info("글 주소 : " + writeInfoVO.getWrite_address());
