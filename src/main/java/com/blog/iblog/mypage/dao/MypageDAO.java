...
public class MypageDAO {
	...
	public void addCategory(Iblog_categoryVO iblog_categoryVO) {
		...
		for(int i=0;i<iblog_categoryVO.getCategory_num().size();i++) {
			...
			System.out.println("category_num : " +map.get("category_num"));
			System.out.println("category_value : " + map.get("category_value"));
			System.out.println("category_kind : " + map.get("category_kind"));
